...
This is a dockerized version of the original, and cool https://github.com/trehn/termdown project!

## Docker based usage:
```
docker run -it --rm barnabasszabo/termdown 90
```

### TL;DR
```
docker run -it --rm barnabasszabo/termdown [OPTIONS] [TIME]
